...
window.App = function App() { // FINAL STRUCTURAL FIX: ensures component is globally accessible
                    ...
                    return `
                        <div id="athlete-${athlete.id}" onClick={() => togglePresence(athlete.id)}
                            ...
                            <div className="flex items-center space-x-2">
                                <span className="text-lg font-medium ${isChecked ? 'text-yellow-800' : 'text-gray-700'}">${athlete.name}</span>
                                <span className="text-xs font-semibold bg-yellow-500 text-white px-2 py-0.5 rounded-full">MAKE-UP CANDIDATE</span>
                            </div>

                            <span className="text-sm font-bold ${isChecked ? 'text-yellow-800' : 'text-gray-400'}">
